    ...
    <v-container fluid>
                    ...
                    <v-row align="end" justify="center">
                        <v-col class="text-center" cols="12">
                            ...
                            <h4 class="text-overline">
                                Distribute, Swap, Monitor, and edit, With one
                                click!
                            </h4>
                        </v-col>
                    </v-row>
        ...
        <v-row style="margin-top: 5%;" justify="space-around" align="center">
            <v-col cols="12" lg="3" md="3">
                <div class="text-center">
                    <h1 class="text-h3 font-weight-light">
                        {{ date_time | getDay }} {{ date_time | getMonth }}
                    </h1>
                    <h5 class="text-h5 font-weight-light">
                        {{ date_time | getDayName }}
                    </h5>
                ...
                <v-hover v-slot="{ hover }">
                    <v-card hover color="grey lighten-5">
                        ...
                        <v-card-text>
                            <v-chip small dark color="green darken-2"
                                ><v-icon left>mdi-account-group</v-icon>2 /
                                3</v-chip
                            >
                            <v-chip small outlined
                                ><v-icon left>mdi-clock-outline</v-icon
                                >{{ date_time | ago }}</v-chip
                            >
                        </v-card-text>
                        <v-expand-transition>
                            <div
                            ...
                            >
                                <span
                                    ...
                                    ><v-icon dark x-large left color="success"
            ...
            <v-col cols="12" lg="4" md="4">
                ...
                <p class="text-body-1 text-center">
                    With EDOS, users are freely to choose the date / time slot
                    to be attached, without knowing the full details of inv.
                    <br />
                    The Admin has the ability to make all the details visible /
                    hidden.
                </p>
            </v-col>
        </v-row>
        <v-row justify="space-around" align="center">
            <v-col cols="12" lg="4" md="4">
                ...
                <p class="text-body-1 text-center">
                    Users are free to remove the registered invs or swap it with
                    your colleagues, no extra paper work, no extra overhead and
                    time waste. <br />
            ...
            <v-col cols="12" lg="3" md="3">
                ...
                <v-hover v-slot="{ hover }">
                    <v-card hover color="green lighten-5">
                        ...
                        <v-card-text>
                            <v-chip small dark color="red darken-2"
                                ><v-icon left>mdi-account-group</v-icon>3 /
                                3</v-chip
                            >
                            <v-chip small outlined
                                ><v-icon left>mdi-clock-outline</v-icon
        ...
        <v-row style="margin-top: 3%" justify="center">
            <v-col cols="10" lg="5" md="5">
                <div
                    class="d-flex justify-center mt-6 align-center"
                    v-if="view == 'grid'"
                >
                    <v-sheet
                    ...
                    <v-sheet
                        class="ml-4 d-flex align-center justify-center"
                        color="red"
                        elevation="5"
                        height="50"
                        rounded
            ...
            <v-col cols="12" lg="6" md="6">
                ...
                <p class="text-body-1 text-center">
                    Using EDOS make it easier to swap and switch between Grid
                    mode or Table mode which can be switched with a single
                    click. Choose your favourite layout of the information.
                </p>
            </v-col>
        </v-row>
        <v-row style="margin-top: 5%" align="center" justify="space-around">
            <v-col cols="12" lg="4" md="4">
                ...
                <p class="text-body-1 text-center">
                    To use EDOS you are welcomed to register, but the admin
                    should first add you as a new user so you can register in
                    the system and set your password for the first time. EDOS
                    not for everyone.
                </p>
            </v-col>
            <v-col cols="12" lg="4" md="4">
                ...
                <h5 class="body-1 text-center mt-2">
                    Don't have an account?
                    <router-link id="router-link" to="register"
