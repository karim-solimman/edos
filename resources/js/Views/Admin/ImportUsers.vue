        ...
        <v-row>
            <v-col cols="12" lg="6" md="6">
                <v-form @submit.prevent="upload" ref="form">
                    ...
                    <v-btn :loading="btnLoading" type="submit"
                ...
                <p class="text-body-1">
                    ...
                    <strong>[#] [name] [email] [department]</strong> all lower
                    case without any white spaces.
                </p>
                <p class="text-body-1">
                    <strong>Department</strong>, for department column you may
                    write full / part of the department name stored in EDOS,
                    either lower or upper case it will work, if EDOS failed to
                    find the department the user won't be attached to any
                    department until the admin update it.
                </p>
            </v-col>
            <v-col cols="12" lg="6" md="6">
