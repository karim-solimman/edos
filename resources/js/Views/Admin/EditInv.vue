        ...
        <v-row v-if="!loading && inv">
            <v-col>
                ...
                <h2 class="text-h5 font-weight-light">
                    {{ inv.date_time | TimeFormat }}
                </h2>
                <h3 class="text-caption">
                    {{ inv.room.number }} / {{ inv.course.code }} /
                    {{ inv.course.name }} /
                    {{
                        inv.course.department
        ...
        <v-row v-if="!loading && inv">
            <v-col cols="12" lg="6" md="6">
                <v-card color="grey lighten-4">
                    ...
                    <v-card-actions>
                        <v-btn @click="updateInfo" block color="primary" text
                ...
                <v-card class="mt-6" color="grey lighten-5">
                    ...
                    <v-card-text>
                        <p class="text-body-1">
                            <strong>Warning</strong>, by deleting the inv all
                            users attached to this inv will be cleared from inv
                            resgitration, this action can't be undo
                        </p>
                    </v-card-text>
                    <v-card-actions>
                        <v-btn @click="confirmInv(inv.id)" block color="error"
                            ><v-icon left>mdi-delete</v-icon>delete inv</v-btn
                        >
                    </v-card-actions>
                </v-card>
            </v-col>
            <v-col cols="12" lg="6" md="6">
                ...
                <v-card class="mt-6" color="grey lighten-5">
                    ...
                    <v-card-text>
                        <v-simple-table
                            v-if="!loading && inv.users && inv.users.length > 0"
                        >
                            <thead>
                                <tr>
                                    <th>#</th>
