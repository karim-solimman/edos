    ...
    <v-navigation-drawer disable-resize-watcher v-model="drawer" app>
        <v-list dense>
            <v-list-item>
                <v-list-item-content>
                    <v-list-item-title class="text-h6">
                        <v-badge content="1.0">
                            <v-icon small left>mdi-vector-polyline-edit</v-icon>
                            EDOS
                        </v-badge>
                    </v-list-item-title>
                    <v-list-item-subtitle
                        >Exams Distribution Observers
            ...
            >
                ...
                >
                    <v-list-item-icon
                        ><v-icon>mdi-table-plus</v-icon></v-list-item-icon
                    >
                    <v-list-item-content>
            ...
            >
                ...
                >
                    <v-list-item-icon
                        ><v-icon>mdi-door-closed</v-icon></v-list-item-icon
                    >
                    <v-list-item-content>
                ...
                >
                    <v-list-item-icon
                        ><v-icon>mdi-door-open</v-icon></v-list-item-icon
                    >
                    <v-list-item-content>
            ...
            >
                ...
                >
                    <v-list-item-icon
                        ><v-icon
                            >mdi-book-multiple-outline</v-icon
                        ></v-list-item-icon
                    >
                    <v-list-item-content>
            ...
            >
                <v-list-item-icon
                    ><v-icon>mdi-lock-check-outline</v-icon></v-list-item-icon
                >
                <v-list-item-content
                    ><v-list-item-title
                        >Roles and Permissions</v-list-item-title
                    ></v-list-item-content
                >
            </v-list-item>
            ...
            >
                ...
                <v-list-item-content
                    ><v-list-item-title
                        >System Settings</v-list-item-title
                    ></v-list-item-content
                >
            </v-list-item>
            ...
            <v-list-item
                color="primary"
                style="text-decoration:none"
                v-if="isUser && isManualSelection"
                link
                :to="{ name: 'invs' }"
            >
                <v-list-item-icon
                    ><v-icon>mdi-table-eye</v-icon></v-list-item-icon
                >
                <v-list-item-content
                    ><v-list-item-title
                        >Invs</v-list-item-title
                    ></v-list-item-content
                >
            </v-list-item>
...
export default {
    ...
    watch: {
        drawerToggle: function(newVal, oldVal) {
            this.drawer = newVal;
        },
        drawer: function(newVal, oldVal) {
            if (oldVal) this.$emit("drawer-close");
        }
    }
};
</script>
